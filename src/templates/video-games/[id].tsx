          ...
          const mainInfo = (
            <>
              <p className="mt-2 flex items-center">
                ...
                <strong>Time Played:</strong> {game.timePlayed}
              </p>
              <p className="mt-2 flex items-center">
                <FaTrophy className="mr-2 text-gray-500" />
                <strong>Completed on:</strong> {game.dateFinished}
              </p>
            </>
          );
              ...
              <DetailSidebarBox title="Ratings">
                <ul className="list-disc list-inside">
                  <li className="flex items-center">
                    <FaSteam className="mr-2 text-gray-700" />
                    <strong>Steam:</strong> {game.rating.steam}
                  </li>
                  <li className="flex items-center">
                    <FaNewspaper className="mr-2 text-gray-700" />
                    <strong>Metacritic:</strong> {game.rating.metacritic}
                  </li>
                  <li className="flex items-center">
                    <FaNewspaper className="mr-2 text-gray-700" />
                    <strong>IGN:</strong> {game.rating.ign}
                  </li>
                  <li className="flex items-center">
                    <FaNewspaper className="mr-2 text-gray-700" />
                    <strong>GameSpot:</strong> {game.rating.gamespot}
                  </li>
                </ul>
              </DetailSidebarBox>
              ...
              <DetailSidebarBox title="Details">
                <ul className="list-none space-y-2">
                  ...
                  <li className="flex items-center">
                    ...
                    <strong>Developer:</strong> {game.studio}
                  </li>
                  <li className="flex items-center">
                    <FaClock className="mr-2 text-gray-700" />
                    <strong>Average Duration:</strong> {game.averageDuration}
                  </li>
                  <li className="flex items-center">
